...
router
  .route("/create")
  .post(TokenVerify, upload.single("image"), CreateRemedies);
...
router
  .route("/updateprofile")
  .post(TokenVerify, upload.single("profileImage"), updateProfile);
router.route("/editprofile").post(TokenVerify, editProfile);
